export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx07cb1053e2a7a94b",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8d107bbbfed01dd2c6652aeccf21516a",
  ...
  USERS: [
    {
      ...
      id: "oX7WV6gQMmR7b77HwMrgUKErYvRw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "vZh2iViBdCAWq7McK7FO4GjwGeegC9bK-Rlgjx0KDKM",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南京",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "祖宗", "year": "1996", "date": "10-10"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "祖宗", "year": "1996", "date": "11-20"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2017-11-25"},
        // 结婚纪念日
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oiWNF6IolUkLS8hISiXVpu3YjnjE",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
